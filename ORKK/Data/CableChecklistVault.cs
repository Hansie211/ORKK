...
namespace ORKK.Data
{
    ...
    {
        private static readonly List<CableChecklistObject> CableChecklists = new List<CableChecklistObject>();
        ...
        public static ReadOnlyCollection<CableChecklistObject> GetCableChecklists()
        {
            return CableChecklists.AsReadOnly();
        }
    ...
    public class CableChecklistObject
    {
        ...
        public int DamageRustCorrosion;
